...
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "abfss://bronze@ayushproject2sa.dfs.core.windows.net/hosa/encounters"
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TEMP VIEW hosb_encounters
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "abfss://bronze@ayushproject2sa.dfs.core.windows.net/hosb/encounters"
# MAGIC );
# MAGIC
