...
claims_landing_path = 'abfss://landing@ayushproject2sa.dfs.core.windows.net/'+'claims/'
claims_bronze_path = 'abfss://bronze@ayushproject2sa.dfs.core.windows.net/'+'claims/'

claims_df=spark.read.csv(claims_landing_path+"*.csv",header=True)
...
claims_df.write.format("parquet").mode("overwrite").save(claims_bronze_path)
