...
df_hosa=spark.read.parquet("abfss://bronze@ayushproject2sa.dfs.core.windows.net/hosa/patients")
df_hosa.createOrReplaceTempView("patients_hosa")

#Reading Hospital B patient data 
df_hosb=spark.read.parquet("abfss://bronze@ayushproject2sa.dfs.core.windows.net/hosb/patients")
