...
df_hosa=spark.read.parquet("abfss://bronze@ayushproject2sa.dfs.core.windows.net/hosa/providers")

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("abfss://bronze@ayushproject2sa.dfs.core.windows.net/hosb/providers")
