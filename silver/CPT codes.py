...
cptcode_path = 'abfss://landing@ayushproject2sa.dfs.core.windows.net/'+'cptcodes/'

cptcode_bronze_path = 'abfss://landing@ayushproject2sa.dfs.core.windows.net/'+'cpt_codes/'

# Read the CSV file
cptcodes_df = spark.read.csv(cptcode_path+"*.csv", header=True)
...
cptcodes_df.write.format("parquet").mode("overwrite").save(cptcode_bronze_path)
